...
Read `.yisiui/config.json`, `.yisiui/sync-lock.json`, the synchronized shared Registry, the local Registry, the component implementation, Stories, tests, and real product usage. First decide whether reuse, composition, or an existing variant/slot already covers the responsibility.
